...
public class disbursementItemAdapter extends ArrayAdapter<DisbursementItem> {
    private List<DisbursementItem> requisitionItemForApprovalList;
    int resource;

    public disbursementItemAdapter(Context context, int resource, List<DisbursementItem> requisitionItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DisbursementItem requisitionItems = requisitionItemForApprovalList.get(position);
