...
public class adjustmentCRUDAdapter extends ArrayAdapter<Adjustment> {
    private List<Adjustment> adjustmentList;
    int resource;
    public adjustmentCRUDAdapter(Context context, int resource, List<Adjustment> adjustments) {
