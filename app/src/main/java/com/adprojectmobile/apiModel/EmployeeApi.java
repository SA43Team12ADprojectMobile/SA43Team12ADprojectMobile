...
public class EmployeeApi implements Parcelable{
    ...
    public EmployeeApi(String employeeID, String departmentName, String name, String position, String number, String emailAddress, String isDelegated, String delegationStartDate, String delegationEndDate) {
    ...
    protected EmployeeApi(Parcel in) {
    ...
    public static final Creator<EmployeeApi> CREATOR = new Creator<EmployeeApi>() {
        @Override
        public EmployeeApi createFromParcel(Parcel in) {
            return new EmployeeApi(in);
        }

        @Override
        public EmployeeApi[] newArray(int size) {
            return new EmployeeApi[size];
        }
    };
