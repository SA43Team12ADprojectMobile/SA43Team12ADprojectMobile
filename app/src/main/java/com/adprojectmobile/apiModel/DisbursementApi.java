...
public class DisbursementApi implements Parcelable{
    ...
    public DisbursementApi(String disbursementID, String collectionPointName, String retrievalDate, String deliveryStatus, String repName, String repChecked, String clerkChecked) {
    ...
    protected DisbursementApi(Parcel in) {
    ...
    public static final Creator<DisbursementApi> CREATOR = new Creator<DisbursementApi>() {
        @Override
        public DisbursementApi createFromParcel(Parcel in) {
            return new DisbursementApi(in);
        }

        @Override
        public DisbursementApi[] newArray(int size) {
            return new DisbursementApi[size];
        }
    };
