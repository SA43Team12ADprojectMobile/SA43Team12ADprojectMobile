...
public class RequisitionItemsforApprove extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Requisition requisition = getIntent().getParcelableExtra("requisition");
        ...
        new AsyncTask<Requisition, Void, List<RequisitionItem>>() {
            ...
            protected List<RequisitionItem> doInBackground(Requisition... params) {
                List<Requisition> requisitions = aDao.getAllRequisition(empId);
                ...
                final List<RequisitionItem> retrievalItems = aDao.getItemByRequisition(requisition);
